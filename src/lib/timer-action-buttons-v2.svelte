...
let {onPlay, onPause, onReset} = $props<{onPlay: () => void, onPause: () => void, onReset: () => void}>();

</script>

<div class="radio-input">
	<label class="label" onclick={onPlay}>
		<input value="value-1" name="value-radio" id="value-1" type="radio" />
		<span class="text">Play</span>
	</label>
	<label class="label" onclick={onPause}>
		<input value="value-1" name="value-radio" id="value-1" type="radio" />
		<span class="text">Pause</span>
	</label>
	<label class="label" onclick={onReset}>
		<input value="value-1" name="value-radio" id="value-1" type="radio" />
...
<style>
	...
	.label:has(input[type='radio']:checked)::before {
		background: linear-gradient(to bottom, transparent 10%, #cae2fd63, transparent 90%);
	}
